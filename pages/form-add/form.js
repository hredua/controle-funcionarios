...
function myScope () {
    ...
    function fillContractScreen(contract){
        if (contract.type == "boss") {
            contratante.checked = true;
            name.value = contract.name
            lastName.value = contract.lastName
            dateInit.value = contract.date
            endDate.value = contract.endDate
            vacance.value = contract.vacancy
            vacancyValue.value = contract.vacancyValue
            ...
            name.value = contract.name
            lastName.value = contract.lastName
            motherName.value = contract.motherName
            bday.value = contract.bday
            geralRegister.value = contract.geralRegister
            reference1Name.value = contract.referenceOneName
            reference1Phone.value = contract.referenceOnePhone
            reference2Name.value = contract.referenceTwoName
            reference2Phone.value = contract.referenceTwoPhone
            validateFields()
